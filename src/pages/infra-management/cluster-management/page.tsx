...
const columns = [
  {
    id: 'name',
    header: '이름',
    accessorFn: (row: ClusterRow) => row.name,
    size: 300,
  },
  {
    id: 'workflow',
    header: '워크플로우',
    accessorFn: (row: ClusterRow) => row.workflow,
    size: 300,
  },
  {
    id: 'type',
    header: '유형',
    accessorFn: (row: ClusterRow) => row.type,
    size: 285,
  },
  {
    id: 'desc',
    header: '설명',
    accessorFn: (row: ClusterRow) => row.desc,
    size: 334,
  ...
  },
  {
    id: 'date',
    header: '생성일시',
    accessorFn: (row: ClusterRow) => row.date,
    size: 325,
  },
];

const rowData: ClusterRow[] = [];
